     ...
     setLayout: function(){
      ...
      $("#build-menu-button, #build-menu-overlay").on("click", function(e){
        ...
        if(html.hasClass("build-menu-open")){
          ...
          $("#build-menu").css('visibility', 'hidden');
          ...
          $("#build-menu").css('visibility', 'visible');

          page.css({
            "-webkit-transform": "translate3d("+_this.config.menu_width+"px"+", 0, 0)",
            "-moz-transform": "translate3d("+_this.config.menu_width+"px"+", 0, 0)",
            "-o-transform": "translate3d("+_this.config.menu_width+"px"+", 0, 0)",
            "-ms-transform": "translate3d("+_this.config.menu_width+"px"+", 0, 0)",
            "transform": "translate3d("+_this.config.menu_width+"px"+", 0, 0)"
          });

          overlay.css("visibility", "visible").fadeTo("",0.5);
        }
      });
}
};
